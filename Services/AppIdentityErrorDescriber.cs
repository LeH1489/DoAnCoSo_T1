...
{
  public class AppIdentityErrorDescriber : IdentityErrorDescriber  //override lại
  {
      ...
      public override IdentityError DuplicateRoleName(string role)
      {
          ...
          { 
              Code  = er.Code,  //hiển thị ra code (vd: 405) của lỗi thông qua method base 
              Description = $"Tên {role} này đã có! Vui lòng chọn tên Role khác"
          };
      }
